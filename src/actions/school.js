...
const fields: string = "&_fields=id,school.name,school.state,2015.cost.avg_net_price.public,2015.cost.tuition.in_state,2015.cost.tuition.out_of_state,2015.cost.tuition.program_year,school.state_fips,school.locale,school.degrees_awarded.predominant,school.degrees_awarded.highest,2015.cost.attendance.academic_year,2015.student.size,2015.academics.program_available.bachelors,2015.academics.program_available.assoc,2015.admissions.admission_rate.overall,school.ownership,school.school_url"
...
// function getProgram(listOfItems) {
//   let temp = "";
//   for(let i = 0; i < listOfItems.length; i++)
//   {
//       temp = temp + "&2015.academics.program.degree." + listOfItems[i]+"=1";
//     console.log(temp);
//     return temp;
//   }
// }
